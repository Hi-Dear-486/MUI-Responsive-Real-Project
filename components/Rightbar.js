...
import { itemData } from "@/app/api/Api";
    ...
    <>
      <Box flex={1} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
        <Box position={"fixed"} p={2}>
          <Typography fontWeight={300} variant="h6" color={"gray"} mb={5}>
            Online Friends
          </Typography>
          <Stack direction="row" spacing={-1} mb={4}>
            ...
            >
              <Avatar
                alt="Remy Sharp"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU0zYcypyreQSHIWXlpNM2hnAi6gJlYkX3vA&s"
              />
            </StyledBadge>
            <StyledBadge
              overlap="circular"
            ...
            >
              <Avatar
                alt="Remy Sharp"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4YQjDhI7IZIuDknaEvb--KHsQzVEf6r8x0A&s"
              />
            </StyledBadge>
            <StyledBadge
              overlap="circular"
          ...
          <Typography fontWeight={300} variant="h6" color={"gray"} mb={2}>
            Latest Photos
          </Typography>
          <ImageList
            sx={{
